...
public class MissingNumberTest {
    ...
    public ArrayList<Integer> repeatedNumber(final List<Integer> a) {
        ...
        long sumOfNNumbers = length*(length+1)/2;
        long missingNumber = getMissingNumber(array);
        Integer A = (int)(missingNumber - (sumOfNNumbers - arraySum));
